...
const Home = () => {
    ...
    return (
        <>
            <div className="py-24 flex flex-col items-center justify-center text-center text-5xl bg-gradient-to-b from-blueGray-900 to-blueGray-500 text-white sm:text-6xl">
