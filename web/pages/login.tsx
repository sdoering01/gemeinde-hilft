...
const login: React.FC<Props> = () => {
    ...
    } = useMutation(async (password: string) => checkPasswordCall(password), {
        onSuccess: () => {
        ...
        <LoggedOutExclusive>
            <Layout>
                <Card size={CardSize.SMALL} className="mx-auto text-center">
                    ...
                    <p>
                        Um diese Seite zu nutzen ist ein Passwort notwendig.
                        Dieses wird in der Infomail rumgeschickt.
                    </p>
                    <form
